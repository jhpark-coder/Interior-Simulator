...
> = {
  ...
  "monitor-stand": { label: "모니터 스탠드", width: 550, depth: 350, height: 450 },
  "monitor-arm": { label: "모니터암", width: 150, depth: 400, height: 500 },
...
export const ITEM_CATALOG: ItemDefinition[] = [
  ...
  },
  {
    ...
    height: 450,
    tags: ["모니터", "스탠드", "거치대"],
    keywords: ["monitor", "stand", "riser", "모니터", "스탠드", "거치대"],
  },
  {
    id: "monitor-arm-pole",
    type: "monitor-arm",
    ...
    height: 500,
    tags: ["모니터암", "기둥형", "거치대", "폴"],
    keywords: ["monitor arm", "pole", "모니터암", "기둥형", "폴마운트"],
  },
  {
    ...
    depth: 450,
    height: 450,
    tags: ["모니터암", "암형", "거치대", "클램프"],
    keywords: ["monitor arm", "clamp", "모니터암", "암형", "클램프"],
  },
